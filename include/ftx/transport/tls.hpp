...
[[nodiscard]] std::unique_ptr<asio::ssl::context> make_server_tls_context(const TlsConfig& cfg);

[[nodiscard]] std::unique_ptr<asio::ssl::context> make_client_tls_context(const TlsConfig& cfg);
